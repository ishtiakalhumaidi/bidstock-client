...
export const mockAdminData = {
  ...
  analytics: {
    ...
    avgBidsPerPR: 3.25,
    topSuppliers: [
      { name: "FastForge Ltd", score: 94, wins: 12 },
      { name: "SteelPro Supplies", score: 88, wins: 9 },
      { name: "ChemCoat", score: 85, wins: 7 },
    ],
    monthlySavings: [
      { month: "Aug", savings: 2800 },
      { month: "Sep", savings: 3200 },
      { month: "Oct", savings: 4100 },
      { month: "Nov", savings: 2350 },
    ],
    rentalIncome: 8750,
...
export const fetchMockAdminData = async () => {
  await delay(1000);
