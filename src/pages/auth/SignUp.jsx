...
import { User, Mail, Lock, Eye, EyeOff, ArrowRight, Package, Warehouse, Briefcase } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500 mt-2">Join the marketplace for modern supply chains</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-3">
            <label className="text-sm font-semibold text-zinc-700 ml-1">I want to...</label>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {/* Buyer Option */}
              <div 
                onClick={() => handleRoleSelect('buyer')}
                className={`cursor-pointer rounded-xl border-2 p-4 flex flex-col items-center gap-2 transition-all ${selectedRole === 'buyer' ? 'border-rose-500 bg-rose-50 text-rose-700' : 'border-zinc-100 bg-white text-zinc-500 hover:border-rose-200'}`}
              >
              ...
              <div 
                ...
                className={`cursor-pointer rounded-xl border-2 p-4 flex flex-col items-center gap-2 transition-all ${selectedRole === 'supplier' ? 'border-rose-500 bg-rose-50 text-rose-700' : 'border-zinc-100 bg-white text-zinc-500 hover:border-rose-200'}`}
              >
              ...
              <div 
                ...
                className={`cursor-pointer rounded-xl border-2 p-4 flex flex-col items-center gap-2 transition-all ${selectedRole === 'warehouse' ? 'border-rose-500 bg-rose-50 text-rose-700' : 'border-zinc-100 bg-white text-zinc-500 hover:border-rose-200'}`}
              >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`w-full pl-11 pr-4 py-3 rounded-xl border ${errors.name ? 'border-red-500' : 'border-zinc-200 focus:border-rose-500 focus:ring-rose-500'} bg-white focus:ring-2 focus:outline-none transition-all`}
                />
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`w-full pl-11 pr-4 py-3 rounded-xl border ${errors.email ? 'border-red-500' : 'border-zinc-200 focus:border-rose-500 focus:ring-rose-500'} bg-white focus:ring-2 focus:outline-none transition-all`}
                />
              </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className={`w-full pl-11 pr-12 py-3 rounded-xl border ${errors.password ? 'border-red-500' : 'border-zinc-200 focus:border-rose-500 focus:ring-rose-500'} bg-white focus:ring-2 focus:outline-none transition-all`}
              />
              <button 
                type="button"
          ...
          <div className="flex items-start gap-3 mt-2">
            ...
            <label className="text-sm text-zinc-500">
              I agree to the <a href="#" className="text-rose-600 font-semibold hover:underline">Terms of Service</a> and <a href="#" className="text-rose-600 font-semibold hover:underline">Privacy Policy</a>.
            </label>
          </div>
        ...
        <div className="mt-8 text-center border-t border-zinc-100 pt-6">
          <p className="text-zinc-500 text-sm">
            ...
            <Link to="/auth/signin" className="font-semibold text-rose-600 hover:text-rose-700 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
