...
const StatCard = ({ title, value, icon: Icon, color, subtext, link }) => (
  <Link
    to={link}
    className="bg-white p-6 rounded-2xl shadow-sm border border-zinc-100 flex items-center justify-between hover:shadow-md transition-all"
  >
    <div>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white p-6 rounded-2xl border border-zinc-100 shadow-sm h-64 flex flex-col justify-center items-center text-center">
        ...
        <p className="text-sm text-zinc-500 mt-1">
          Detailed transaction logs and notifications will appear here.
        </p>
      </div>
    </div>
  );
